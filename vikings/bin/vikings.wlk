...
// y serInvadidoPor (y siempre y cuando no necesite más cosas del vikingo para resolver esos métodos,
// en cuyo caso convendría pasar el vikingo por parámetro)